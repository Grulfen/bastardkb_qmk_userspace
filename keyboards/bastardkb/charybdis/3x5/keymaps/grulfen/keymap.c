 ...
 */
    [_MOUSE] = LAYOUT(
     ...
     DRGSCRL, _______, MS_BTN1, MS_BTN2, _______,    _______, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
     SNIPING, _______, _______, _______, _______,    _______, _______, _______, _______, _______,
                       _______, _______, _______,    _______, _______
    ),
